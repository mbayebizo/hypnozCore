...
public enum RequestErrorEnum {
    ...
    CODE_EMPTY(HttpStatus.BAD_REQUEST,HttpStatus.BAD_REQUEST.name(),"Code is empty","Code is empty" ),
    ...
    NOT_FOUND(HttpStatus.NOT_FOUND, HttpStatus.NOT_FOUND.name(), "Not FOUND" ,"Find not found" ),
